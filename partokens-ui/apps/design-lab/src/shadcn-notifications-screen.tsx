        ...
        <form noValidate onSubmit={openSave} className='space-y-4'>
          <fieldset disabled={busy} className='m-0 min-w-0 space-y-4 border-0 p-0'>
            ...
            <section className='overflow-hidden rounded-lg border border-warning/30'>
              <header className='border-b border-warning/20 bg-warning/5 px-4 py-3'><div className='flex items-start gap-3'><ShieldCheck className='mt-0.5 size-5 shrink-0 text-warning' /><div><p className='text-xs font-medium text-muted-foreground'>PRIVATE BEHAVIOR</p><h2 className='mt-0.5 text-base font-semibold'>Request handling</h2><p className='mt-1 text-sm text-muted-foreground'>Sensitive options require confirmation before they enter the draft.</p></div></div></header>
